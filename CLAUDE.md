...
Backend reads: `DB_HOST, DB_PORT, DB_USER, DB_PASSWORD, DB_NAME, PORT, NODE_ENV, FRONTEND_URL, AUTO_MIGRATE, APPROVE_MIGRATIONS, FORCE_PRODUCTION_MIGRATION, GOOGLE_CLIENT_ID, GOOGLE_CLIENT_SECRET, CLOUDINARY_CLOUD_NAME, CLOUDINARY_API_KEY, CLOUDINARY_API_SECRET`.
