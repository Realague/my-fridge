...
import stockExitRoutes from './routes/stockExits';
import householdActivityRoutes from './routes/householdActivities';
import householdStatsRoutes from './routes/householdStats';
import itemSuggestionRoutes from './routes/itemSuggestions';
import householdSettingsRoutes from './routes/householdSettings';
...
app.use('/api/households', stockExitRoutes);
app.use('/api/households', householdActivityRoutes);
app.use('/api/households', householdStatsRoutes);
app.use('/api/households', itemSuggestionRoutes);
app.use('/api/households', householdSettingsRoutes);
